...
bboxLength = 96
trained_w_fg = True # indicate that the model is trained on foreground images (median background subtracted)
...
def get_model():
    ...
    best_weights = np.load('models/lasagne/best_weights_nouriNet6-fg.pickle')['best_weights']
